...
if {![file exists $proj_root_dir/modelsim/uvvm]} {
    ...
    file mkdir $proj_root_dir/modelsim/uvvm

    # Create a file with instructions how to recompile the library, if needed
    set uvvm_path "$proj_root_dir/modelsim/uvvm/where_compiled.txt"
    ...
    puts $new_uvvm_lib "By deleting the folder './modelsim/uvvm/', after running 'make sim' or 'make sim_gui'"
