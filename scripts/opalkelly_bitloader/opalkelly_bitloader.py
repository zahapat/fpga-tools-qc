...
# Qubit 1H
GEN3_VAL = 756501   # INT_ALL_DIGITS_PHOTON_1H_DELAY_NS
GEN4_VAL = 2        # INT_WHOLE_DIGITS_CNT_PHOTON_1H_DELAY (not part of the build name -> "")
# Qubit 1V
GEN5_VAL = 7501     # INT_ALL_DIGITS_PHOTON_1V_DELAY_NS
GEN6_VAL = 2        # INT_WHOLE_DIGITS_CNT_PHOTON_1V_DELAY (not part of the build name -> "")

# Qubit 2H
GEN7_VAL = -103095  # INT_ALL_DIGITS_PHOTON_2H_DELAY_NS
GEN8_VAL = 4        # INT_WHOLE_DIGITS_CNT_PHOTON_2H_DELAY (not part of the build name -> "")
# Qubit 2V
GEN9_VAL = -103435  # INT_ALL_DIGITS_PHOTON_2V_DELAY_NS
GEN10_VAL = 4       # INT_WHOLE_DIGITS_CNT_PHOTON_2V_DELAY (not part of the build name -> "")

# Qubit 3H
GEN11_VAL = -211735 # INT_ALL_DIGITS_PHOTON_3H_DELAY_NS
GEN12_VAL = 4       # INT_WHOLE_DIGITS_CNT_PHOTON_3H_DELAY (not part of the build name -> "")
# Qubit 3V
GEN13_VAL = -212545 # INT_ALL_DIGITS_PHOTON_3V_DELAY_NS
GEN14_VAL = 4       # INT_WHOLE_DIGITS_CNT_PHOTON_3V_DELAY (not part of the build name -> "")

# Qubit 4H
GEN15_VAL = -317795 # INT_ALL_DIGITS_PHOTON_4H_DELAY_NS
GEN16_VAL = 4       # INT_WHOLE_DIGITS_CNT_PHOTON_4H_DELAY (not part of the build name -> "")
# Qubit 4V
GEN17_VAL = -31810  # INT_ALL_DIGITS_PHOTON_4V_DELAY_NS
GEN18_VAL = 4       # INT_WHOLE_DIGITS_CNT_PHOTON_4V_DELAY (not part of the build name -> "")

# Qubit 5H
GEN19_VAL = -41771  # INT_ALL_DIGITS_PHOTON_5H_DELAY_NS
GEN20_VAL = 4       # INT_WHOLE_DIGITS_CNT_PHOTON_5H_DELAY (not part of the build name -> "")
# Qubit 5V
GEN21_VAL = -41811  # INT_ALL_DIGITS_PHOTON_5V_DELAY_NS
GEN22_VAL = 4       # INT_WHOLE_DIGITS_CNT_PHOTON_5V_DELAY (not part of the build name -> "")

# Qubit 6H
GEN23_VAL = -51771  # INT_ALL_DIGITS_PHOTON_6H_DELAY_NS
GEN24_VAL = 4       # INT_WHOLE_DIGITS_CNT_PHOTON_6H_DELAY (not part of the build name -> "")
# Qubit 6V
GEN25_VAL = -51811  # INT_ALL_DIGITS_PHOTON_6V_DELAY_NS
GEN26_VAL = 4       # INT_WHOLE_DIGITS_CNT_PHOTON_6V_DELAY (not part of the build name -> "")
