...
# Photon Delays: 
#     Note: if DECIM value is 05, it will be converted to a valid integer, i.e. 5
# Qubit 2H
GEN3_NAME ?= INT_WHOLE_PHOTON_2H_DELAY_NS
GEN3_VAL ?= -2117
GEN4_NAME ?= INT_DECIM_PHOTON_2H_DELAY_NS
GEN4_VAL ?= 95
# Qubit 2V
GEN5_NAME ?= INT_WHOLE_PHOTON_2V_DELAY_NS
GEN5_VAL ?= -2125
GEN6_NAME ?= INT_DECIM_PHOTON_2V_DELAY_NS
GEN6_VAL ?= 35

# Qubit 3H
GEN7_NAME ?= INT_WHOLE_PHOTON_3H_DELAY_NS
GEN7_VAL ?= -1030
GEN8_NAME ?= INT_DECIM_PHOTON_3H_DELAY_NS
GEN8_VAL ?= 35
# Qubit 3V
GEN9_NAME ?= INT_WHOLE_PHOTON_3V_DELAY_NS
GEN9_VAL ?= -1034
GEN10_NAME ?= INT_DECIM_PHOTON_3V_DELAY_NS
GEN10_VAL ?= 45

# Qubit 4H
GEN11_NAME ?= INT_WHOLE_PHOTON_4H_DELAY_NS
GEN11_VAL ?= -3177
GEN12_NAME ?= INT_DECIM_PHOTON_4H_DELAY_NS
GEN12_VAL ?= 95
# Qubit 4V
GEN13_NAME ?= INT_WHOLE_PHOTON_4V_DELAY_NS
GEN13_VAL ?= -3181
GEN14_NAME ?= INT_DECIM_PHOTON_4V_DELAY_NS
GEN14_VAL ?= 05

# Qubit 5H
GEN15_NAME ?= INT_WHOLE_PHOTON_5H_DELAY_NS
GEN15_VAL ?= -3181
GEN16_NAME ?= INT_DECIM_PHOTON_5H_DELAY_NS
GEN16_VAL ?= 1
# Qubit 5V
GEN17_NAME ?= INT_WHOLE_PHOTON_5V_DELAY_NS
GEN17_VAL ?= -3181
GEN18_NAME ?= INT_DECIM_PHOTON_5V_DELAY_NS
GEN18_VAL ?= 1

# Qubit 6H
GEN19_NAME ?= INT_WHOLE_PHOTON_6H_DELAY_NS
GEN19_VAL ?= -3181
GEN20_NAME ?= INT_DECIM_PHOTON_6H_DELAY_NS
GEN20_VAL ?= 1
# Qubit 6V
GEN21_NAME ?= INT_WHOLE_PHOTON_6V_DELAY_NS
GEN21_VAL ?= -3181
GEN22_NAME ?= INT_DECIM_PHOTON_6V_DELAY_NS
GEN22_VAL ?= 1

# Qubit 7H
GEN23_NAME ?= INT_WHOLE_PHOTON_7H_DELAY_NS
GEN23_VAL ?= -3181
GEN24_NAME ?= INT_DECIM_PHOTON_7H_DELAY_NS
GEN24_VAL ?= 1
# Qubit 7V
GEN25_NAME ?= INT_WHOLE_PHOTON_7V_DELAY_NS
GEN25_VAL ?= -3181
GEN26_NAME ?= INT_DECIM_PHOTON_7V_DELAY_NS
GEN26_VAL ?= 1

# Qubit 8H
GEN27_NAME ?= INT_WHOLE_PHOTON_8H_DELAY_NS
GEN27_VAL ?= -3181
GEN28_NAME ?= INT_DECIM_PHOTON_8H_DELAY_NS
GEN28_VAL ?= 1
# # Qubit 8V
GEN29_NAME ?= INT_WHOLE_PHOTON_8V_DELAY_NS
GEN29_VAL ?= -3181
GEN30_NAME ?= INT_DECIM_PHOTON_8V_DELAY_NS
GEN30_VAL ?= 1
