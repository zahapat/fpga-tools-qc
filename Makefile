...
# 					  TOP name           QUBITS CNT    EOM PULSE HIGH  EOM PULSE OFF   FEEDFWD PROGRAMMING
#   @$(MAKE) build TOP=top_feedforward   GEN2_VAL=4    GEN27_VAL=25    GEN28_VAL=10    GEN35_VAL=01010111
#   @$(MAKE) build TOP=top_feedforward   GEN2_VAL=4    GEN27_VAL=25    GEN28_VAL=10    GEN35_VAL=01010111
#   @$(MAKE) build TOP=top_feedforward   GEN2_VAL=4    GEN27_VAL=25    GEN28_VAL=10    GEN35_VAL=01010111
