...
proc create_root_design { parentCell } {
    ...
    endgroup
    startgroup
    set_property -dict [list CONFIG.PRIM_IN_FREQ {350.000} CONFIG.CLKOUT1_REQUESTED_OUT_FREQ {85.20833} CONFIG.CLKOUT1_REQUESTED_DUTY_CYCLE {7.1} CONFIG.CLKOUT2_REQUESTED_OUT_FREQ {85.20833} CONFIG.CLKOUT3_REQUESTED_OUT_FREQ {85.20833} CONFIG.CLKOUT4_REQUESTED_OUT_FREQ {85.20833} CONFIG.CLKOUT5_REQUESTED_OUT_FREQ {85.20833} CONFIG.CLKOUT6_REQUESTED_OUT_FREQ {85.20833} CONFIG.CLKOUT7_REQUESTED_OUT_FREQ {85.20833} CONFIG.CLKOUT1_DRIVES {BUFG} CONFIG.CLKOUT2_DRIVES {BUFG} CONFIG.CLKOUT3_DRIVES {BUFG} CONFIG.CLKOUT4_DRIVES {BUFG} CONFIG.CLKOUT6_DRIVES {BUFG} CONFIG.CLKOUT7_DRIVES {BUFG} CONFIG.CLKIN1_JITTER_PS {28.57} CONFIG.FEEDBACK_SOURCE {FDBK_AUTO} CONFIG.MMCM_DIVCLK_DIVIDE {15} CONFIG.MMCM_CLKFBOUT_MULT_F {51.125} CONFIG.MMCM_CLKIN1_PERIOD {2.857} CONFIG.CLKOUT1_JITTER {186.315} CONFIG.CLKOUT1_PHASE_ERROR {240.807} CONFIG.CLKOUT2_JITTER {186.315} CONFIG.CLKOUT2_PHASE_ERROR {240.807} CONFIG.CLKOUT3_JITTER {186.315} CONFIG.CLKOUT3_PHASE_ERROR {240.807} CONFIG.CLKOUT4_JITTER {186.315} CONFIG.CLKOUT4_PHASE_ERROR {240.807} CONFIG.CLKOUT5_JITTER {186.315} CONFIG.CLKOUT5_PHASE_ERROR {240.807} CONFIG.CLKOUT6_JITTER {186.315} CONFIG.CLKOUT6_PHASE_ERROR {240.807} CONFIG.CLKOUT7_JITTER {186.315} CONFIG.CLKOUT7_PHASE_ERROR {240.807}] [get_bd_cells clk_wiz_0]
    endgroup
    ...
    endgroup
    startgroup
    set_property -dict [list CONFIG.PRIM_IN_FREQ {85.208333} CONFIG.CLKOUT1_REQUESTED_OUT_FREQ {249.98621} CONFIG.CLKOUT1_DRIVES {BUFG} CONFIG.CLKIN1_JITTER_PS {117.35} CONFIG.FEEDBACK_SOURCE {FDBK_AUTO} CONFIG.MMCM_DIVCLK_DIVIDE {4} CONFIG.MMCM_CLKFBOUT_MULT_F {49.875} CONFIG.MMCM_CLKIN1_PERIOD {11.736} CONFIG.MMCM_CLKIN2_PERIOD {10.0} CONFIG.MMCM_CLKOUT0_DIVIDE_F {4.250} CONFIG.CLKOUT1_JITTER {192.798} CONFIG.CLKOUT1_PHASE_ERROR {269.305}] [get_bd_cells clk_wiz_1]
    endgroup
